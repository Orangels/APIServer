...
PriorBox::PriorBox(const void* data, size_t length)
{
    ...
    H = read<int>(d);
    W = read<int>(d);
//    mParam.minSize = new float[1];
//    mParam.maxSize = new float[1];
//    mParam.aspectRatios = new float[1];
//    if(mParam.stepW ==8) {
//        mParam.minSize[0] = 20.48;
//        mParam.maxSize[0] = 51.2;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==16) {
//        mParam.minSize[0] = 51.2;
//        mParam.maxSize[0] = 133.12;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==32) {
//        mParam.minSize[0] = 133.12;
//        mParam.maxSize[0] = 215.04;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==64) {
//        mParam.minSize[0] = 215.04;
//        mParam.maxSize[0] = 296.96;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==128) {
//        mParam.minSize[0] = 296.96;
//        mParam.maxSize[0] = 378.88;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==256) {
//        mParam.minSize[0] = 378.88;
//        mParam.maxSize[0] = 460.8;
//        mParam.aspectRatios[0] = 2.0;
//    }
//    else if(mParam.stepW ==512) {
//        mParam.minSize[0] = 460.8;
//        mParam.maxSize[0] = 542.72;
//        mParam.aspectRatios[0] = 2.0;
//    }
